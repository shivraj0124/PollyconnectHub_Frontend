...
function MyHome() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="max-w-7xl mx-auto px-6 max-sm:px-2 py-4 flex justify-between items-center">
          {/* Logo */}
          <div
          ...
          >
            ...
            <span className="syne text-xl max-sm:text-sm tracking-tight">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <motion.div
            ...
            className={`mt-20 inline-flex divide-x rounded-2xl border max-sm:flex-col overflow-hidden
              ${
                theme === "dark"
      ...
      {/* ════ CONTACT ════ */}
      <section id="contact" className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20 lg:py-24">
  <motion.div
    initial={{ opacity: 0, y: 24 }}
    whileInView={{ opacity: 1, y: 0 }}
    viewport={{ once: true }}
    className={`relative overflow-hidden rounded-2xl sm:rounded-3xl border p-6 sm:p-10 lg:p-12 text-center
      ${
        theme === "dark"
  ...
  >
    ...
    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 
      w-[300px] sm:w-[450px] lg:w-[600px] 
      h-[150px] sm:h-[220px] lg:h-[300px] 
      rounded-full blur-[80px] sm:blur-[100px] opacity-20 bg-emerald-500 pointer-events-none" 
    />
    ...
    <div className="relative z-10">
      ...
      <div
        ...
        rounded-xl sm:rounded-2xl mb-5 sm:mb-6
        ${
          theme === "dark"
      ...
      >
        <MdEmail size={22} className="sm:w-6 sm:h-6" />
      </div>

      {/* Heading */}
      <h2
        className={`syne text-2xl sm:text-3xl md:text-4xl mb-3 sm:mb-4 ${
          theme === "dark" ? "text-white" : "text-slate-900"
        }`}
      >
        Let's get in touch
      ...
      {/* Description */}
      <p
        className={`text-sm sm:text-base max-w-md sm:max-w-xl mx-auto mb-6 sm:mb-8 px-2 ${
          theme === "dark" ? "text-slate-400" : "text-slate-500"
        }`}
      >
...
>
  <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8 
    ...
    <div className="flex items-center gap-2">
      ...
      <span
        className={`syne text-sm sm:text-base ${
          theme === "dark" ? "text-white" : "text-slate-900"
        }`}
      >
        PolyConnectHub
    ...
    <div className="flex flex-wrap justify-center md:justify-center items-center gap-4 sm:gap-6 max-w-full">
      {navLinks.map((l) => (
        <a
          ...
          hover:text-emerald-500 whitespace-nowrap ${
            theme === "dark" ? "text-slate-500" : "text-slate-400"
          }`}
        >
          {l}
    ...
    {/* Copyright */}
    <p
      className={`text-[10px] sm:text-xs text-center md:text-right ${
